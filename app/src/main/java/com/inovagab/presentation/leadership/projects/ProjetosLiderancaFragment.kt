package com.inovagab.presentation.leadership.projects
...
class ProjetosLiderancaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            app.projectRepository.observeProjects().collectLatest { projects ->
                ...
                binding.recyclerView.adapter = ProjectAdapter(projects, leadershipMode = true)
            }
        }
    }
